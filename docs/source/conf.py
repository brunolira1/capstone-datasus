...
# capstone_datasus documentation build
...
from capstone_datasus import __version__ as release

# -- Project information -----------------------------------------------------

project = "capstone_datasus"
author = "Kedro"
...
htmlhelp_basename = "capstone_datasusdoc"
...
latex_documents = [
    (
        master_doc,
        "capstone_datasus.tex",
        "capstone_datasus Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "capstone_datasus",
        "Project capstone_datasus codebase.",
        "Data-Science",
    )
]
